...
def create_and_save_plot(data, ticker, period, filename=None, style='default', indicators=['default']):
    """
    ...
    # График полос Боллинджера (если указано)
    if 'Upper_Band' in data.columns and 'Lower_Band' in data.columns and 'MA' in data.columns:
